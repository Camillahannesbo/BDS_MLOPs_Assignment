...
def historical_weater_measures(historical: bool = False, lat: float = 57.048, lon: float = 9.9187, start: str = '2022-01-01', end: str = (date.today()).strftime("%Y-%m-%d")) -> pd.DataFrame:
    """
    ...
    - start and end date is default to '2022-01-01' - today.
